...
class Payone_PaymentRequestAPI_Details_Error extends Payone_PaymentRequestAPI_Details_Item
{
    ...
    /**
     * Payone_PaymentRequestAPI_Details_Error constructor.
     *
    ...
    public function __construct($message)
    {
        ...
        parent::__construct(null, null, null, self::TYPE_ERROR);
    }
